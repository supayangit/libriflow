    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-20 py-10 sm:py-14 lg:py-20">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          <div className="relative w-full h-64 sm:h-96 lg:h-[500px] rounded-xl overflow-hidden shadow-lg dark:shadow-black/30">
            <Image
              src={book.image_url}
              alt={book.title}
              fill
        ...
        <div className="w-full lg:w-1/2 space-y-5 sm:space-y-6">
          ...
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-950 dark:text-white">
              {book.title}
            </h1>
          ...
          <div className="bg-emerald-100 dark:bg-emerald-950/40 p-3 sm:p-4 rounded-lg text-sm">
          ...
          <div className="bg-white/90 dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800 rounded-3xl p-5">
            <h3 className="font-bold mb-2 text-slate-950 dark:text-white">
              Description
            </h3>
